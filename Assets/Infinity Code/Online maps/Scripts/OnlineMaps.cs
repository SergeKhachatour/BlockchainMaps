...
#region Private Fields
    ...
    [SerializeField]
    private float _zoom = 14;

    [SerializeField]
    private double latitude = 34.264967705635449;

    [SerializeField]
    private double longitude = -118.77450914718295;
...
#region Methods
    ...
    private void Start()
    {
        ...
        GameObject myPrefab = Resources.Load("Aircraft") as GameObject;
        if (myPrefab != null)
        {
            //GameObject instance = Instantiate(myPrefab);
            // Set position, parent, etc. as needed
        }
        else
        {
            Debug.LogError("Failed to load Aircraft prefab from Resources folder");
        }
    }
